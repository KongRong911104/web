...
insent_text=sys.argv[7]
row_add=int(sys.argv[8])-4

# #爬蟲區
cs = {}
input_file="../csReview/spider/"+str(year)+"_"+int_semester+".txt"
...
reversed_grouped_list = reversed(grouped_list)
# 处理每个拆分后的 DataFrame
for _, group in reversed_grouped_list:
    # 获取每份中分数最高的两条数据的所有值
...
for i, result in enumerate(result_list):
    ...
    docx_result.append(round(mean,1))
