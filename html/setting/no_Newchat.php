...
<body>
    ...
    <!--顯示群組名稱-->
    <div id="usertop" class="usertop">角色</div>
    <div class="groupsize">
        <!--顯示群組-->
        <ul id="grouplist"></ul>
    </div>
    ...
    <script>
        ...
        $permission = permission_detail_Read('permission', 'groupid', $groupid, 'id', $id);
        $p = detail_Read('allpermission', 'permissionlevel', $permission[0]['permissionlevel'])[0]['permissionname'];
        ?>
        var usertop = document.getElementById('usertop');
        usertop.innerHTML = "角色："+"<?php echo $p?>";
    </script>
    <script>
